...
<header>
    <nav class="navbar navbar-expand-lg">
      <div class="container navbar__container">
        <a class="logo navbar-brand" href="../publisher-main.html">Pet Adoption</a>
          ...
          <div class="navbar-collapse collapse" id="navbarSupportedContent" style>
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="navbar__navitem nav-item">
                <a class="navbar__navlink nav-link" href="../publisher-main.html">Home</a>
              </li>
              <li class="navbar__navitem nav-item">
                <a class="navbar__navlink nav-link" href="publisher_viewPetListing.php">Pet List</a>
              </li>
              <li class="navbar__navitem nav-item">
                <a class="navbar__navlink nav-link" href="../condition.html">Adoption Condition</a>
              </li>
              <li class="navbar__navitem nav-item">
                <a class="navbar__navlink nav-link" href="../aboutus.html">About Us</a>
              </li>
              <li class="navbar__navitem nav-item">
                <a class="navbar__navlink nav-link" href="../contactUs.html">Contact Us</a>
              </li>
            </ul>
          </div>
        </div>
...
form.onsubmit = function(e) {
    ...
    fetch('../admin/adopter_adoptionRequest.php', {
        method: 'POST',
        body: formData
    })
